    ...
    <div class="min-h-screen pt-28 pb-24 px-[max(24px,5vw)] relative">
      ...
      <div class="max-w-2xl mx-auto">
        <div class="mb-10">
          ...
          <h1 class="text-[48px] leading-[1.2] tracking-[-0.02em] font-light text-on-surface">Categories</h1>
          <p class="text-base text-on-surface-variant mt-2">Manage event categories across the platform.</p>
        </div>
        ...
        <div class="bg-surface-container-lowest/80 backdrop-blur-xl rounded-xl p-6 border border-outline-variant/30 shadow-[0_20px_40px_rgba(28,28,23,0.03)] mb-6">
          <h2 class="text-[11px] font-semibold tracking-widest uppercase text-on-surface-variant mb-4">New Category</h2>
          <div class="flex gap-3">
            <input [(ngModel)]="newCategoryName" type="text" placeholder="Category name"
        ...
        <div class="bg-surface-container-lowest/80 backdrop-blur-xl rounded-xl border border-outline-variant/30 shadow-[0_20px_40px_rgba(28,28,23,0.03)] overflow-hidden">
          @if (isLoading()) {
            ...
            <div class="p-12 text-center">
              ...
              <p class="text-base text-on-surface-variant">No categories yet.</p>
            </div>
          } @else {
  ...
  createCategory(): void {
    ...
    this.categoryService.create({ name: this.newCategoryName.trim() }).subscribe({
      next: cat => {
        ...
        this.toast.show('Kategori eklendi.', 'success');
      },
